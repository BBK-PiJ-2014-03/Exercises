...
*   
*   gives the user new features like web browsing with the browseWeb(String) method
*   and allows the user to find their GPS position with findPosition().
*
*/
...
public class SmartPhone extends MobilePhone {
    ...
    *
    *   @param brand the String to be put into the superclass constructor
    *
    */
    ...
    /**
    *
    *   call() function checks if the first two chars of the number parameter are '0' and '0'
    *   if so, prints a message that the call has be placed through the internet
    *   
    ...
    *
    *   @param game the String to be put in the super printGame(String) method
    *
    */
    ...
    *
    *   @param website the website to be browsed
    *
    */
